...
const articles = [
  {
    title: "The Resume Ouroboros: How AI Recruiting Created a Loop Nobody Wins",
    date: "March 4, 2026",
    paragraphs: [
      ...
      "The applicant, catching on eventually because the rejection emails have that same automated coldness regardless of the company's size or logo, learns the lesson the hard way and begins adapting: studying which keywords seem to pass through the scanners, restructuring their experience into a particular syntax, importing the vocabulary of whatever role they're chasing until their resume reads less like a document about a person and more like an SEO-optimized landing page for a human being. And what gets lost in that optimization process is precisely what would make a human recruiter pause and actually want to make a phone call: the idiosyncratic project that doesn't fit neatly into a bullet point, the unconventional career path that suggests genuine curiosity, the particular phrasing that tells you something real about how someone thinks.",
      "What strikes me most when I sit with all of this is that we've constructed a hiring ecosystem where two different kinds of artificial intelligence are essentially negotiating with each other, the resume-generating tools and the resume-scanning tools locked in a kind of arms race, while the actual humans on both ends of the transaction, the recruiter who genuinely wants to find someone good and the applicant who genuinely wants to contribute something real, are increasingly spectators to a process that was ostensibly designed to serve them both.",
    ]
  },
  {
    title: "Online Advertising: The Evolution of Intrusion and the Illusion of Value",
  ...
  {
    title: "Price Personalization: The Paywall You Saw Coming",
    date: "January 5, 2026",
    paragraphs: [
  ...
  {
    title: "The Moderation Paradox: Anonymity, and the Limits of Automated Oversight",
  ...
  {
    title: "Incognito Mode: Perception of Online Privacy vs. Platform Reality",
  ...
  {
    title: "Voice of Reason(ing): Why AI's Vocal Ambitions Miss the Mark or Don't Have One to Miss",
  ...
  {
    title: "GlassMorphism: Fad or the Future?",
  ...
  {
    title: "Playlists: The Pros and Cons",
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '0.5rem', marginTop: '1rem' }}>
            <a href="https://github.com/issamohamed" target="_blank" rel="noopener noreferrer" style={{ color: 'white', opacity: 0.8, transition: 'opacity 0.2s' }} onMouseOver={e => e.currentTarget.style.opacity = '1'} onMouseOut={e => e.currentTarget.style.opacity = '0.8'}><Github size={20} /></a>
            <a href="https://www.linkedin.com/in/issa-mohamed-a2b4a4245/" target="_blank" rel="noopener noreferrer" style={{ color: 'white', opacity: 0.8, transition: 'opacity 0.2s' }} onMouseOver={e => e.currentTarget.style.opacity = '1'} onMouseOut={e => e.currentTarget.style.opacity = '0.8'}><Linkedin size={20} /></a>
            <a href="https://twitter.com/issamohamed23" target="_blank" rel="noopener noreferrer" style={{ color: 'white', opacity: 0.8, transition: 'opacity 0.2s' }} onMouseOver={e => e.currentTarget.style.opacity = '1'} onMouseOut={e => e.currentTarget.style.opacity = '0.8'}><Twitter size={20} /></a>
            <a href="https://www.facebook.com/profile.php?id=100038231138445" target="_blank" rel="noopener noreferrer" style={{ color: 'white', opacity: 0.8, transition: 'opacity 0.2s' }} onMouseOver={e => e.currentTarget.style.opacity = '1'} onMouseOut={e => e.currentTarget.style.opacity = '0.8'}><Facebook size={20} /></a>
            <a href="https://open.spotify.com/user/uchiaclan" target="_blank" rel="noopener noreferrer" style={{ color: 'white', opacity: 0.8, transition: 'opacity 0.2s' }} onMouseOver={e => e.currentTarget.style.opacity = '1'} onMouseOut={e => e.currentTarget.style.opacity = '0.8'}><Music size={20} /></a>
            <a href="https://www.instagram.com/issa101issa/" target="_blank" rel="noopener noreferrer" style={{ color: 'white', opacity: 0.8, transition: 'opacity 0.2s' }} onMouseOver={e => e.currentTarget.style.opacity = '1'} onMouseOut={e => e.currentTarget.style.opacity = '0.8'}><Instagram size={20} /></a>
          </div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: '72rem', margin: '0 auto', marginBottom: '4rem', textAlign: 'center' }}>
        <img src="/images/blog_profile_pic.webp" alt="Picture of the Author: Issa Mohamed" style={{ width: '400px', height: '300px', borderRadius: '1rem', objectFit: 'cover', border: '4px solid rgba(255, 255, 255, 0.3)', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.3)' }} />
      </div>

      <div style={{ maxWidth: '56rem', margin: '0 auto' }}>
        {articles.map((article, index) => (
          <article key={index} ref={index === 0 ? firstArticleRef : null} style={{ marginBottom: '4rem' }}>
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(3rem, 8vw, 5rem)', color: 'white', textAlign: 'center', marginBottom: '1rem', fontWeight: 400 }}>{article.title}</h2>
            <div style={{ fontFamily: 'Georgia, serif', textAlign: 'center', color: 'rgba(255, 255, 255, 0.9)', fontSize: '1.25rem', marginBottom: '2rem' }}>{article.date}</div>
            <div style={articleStyle}>
              <div style={proseStyle}>
                {article.paragraphs.map((para, pIndex) => (
                  <p key={pIndex} style={pIndex < article.paragraphs.length - 1 ? { marginBottom: '1rem' } : {}}>{para}</p>
                ))}
              </div>
            </div>
          </article>
      ...
      {showBackToTop && (
        <button onClick={scrollToTop} style={{ position: 'fixed', bottom: '2rem', right: '2rem', width: '48px', height: '48px', borderRadius: '50%', background: 'rgba(255, 255, 255, 0.15)', border: '1px solid rgba(255, 255, 255, 0.3)', backdropFilter: 'blur(12px)', color: 'white', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.3s ease', zIndex: 60, boxShadow: '0 4px 15px rgba(0, 0, 0, 0.2)' }} onMouseOver={e => { e.currentTarget.style.background = 'rgba(255, 255, 255, 0.25)'; e.currentTarget.style.transform = 'translateY(-2px)'; }} onMouseOut={e => { e.currentTarget.style.background = 'rgba(255, 255, 255, 0.15)'; e.currentTarget.style.transform = 'translateY(0)'; }} aria-label="Back to top">
          <ChevronUp size={24} />
        </button>
      )}
      ...
      {showPopup && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0, 0, 0, 0.6)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100, padding: '1rem' }}>
          <div style={{ background: '#1a2b4c', borderRadius: '1rem', padding: '2rem', maxWidth: '500px', width: '100%', border: '1px solid rgba(255, 255, 255, 0.2)', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.3)', position: 'relative' }}>
            <button onClick={handleClosePopup} style={{ position: 'absolute', top: '1rem', right: '1rem', background: 'none', border: 'none', color: 'rgba(255, 255, 255, 0.7)', cursor: 'pointer', padding: '0.25rem', display: 'flex', alignItems: 'center', transition: 'color 0.2s' }} onMouseOver={e => e.currentTarget.style.color = 'white'} onMouseOut={e => e.currentTarget.style.color = 'rgba(255, 255, 255, 0.7)'}>
              <X size={24} />
            </button>
            <h3 style={{ fontFamily: 'Georgia, serif', fontSize: '1.75rem', color: 'white', marginBottom: '1rem', fontWeight: 400 }}>Stay Updated</h3>
            <p style={{ color: 'rgba(255, 255, 255, 0.9)', lineHeight: '1.6', marginBottom: '1.5rem', fontSize: '1rem' }}>Subscribe to receive timely updates whenever I publish new content.</p>
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              <a href="https://groups.google.com/g/parsing_queries" target="_blank" rel="noopener noreferrer" style={popupButtonStyle} onMouseOver={e => { e.currentTarget.style.background = 'rgba(255, 255, 255, 0.25)'; e.currentTarget.style.transform = 'translateY(-2px)'; }} onMouseOut={e => { e.currentTarget.style.background = 'rgba(255, 255, 255, 0.15)'; e.currentTarget.style.transform = 'translateY(0)'; }}>Join Google Group</a>
              <a href="https://substack.com/@issamohamed" target="_blank" rel="noopener noreferrer" style={popupButtonStyle} onMouseOver={e => { e.currentTarget.style.background = 'rgba(255, 255, 255, 0.25)'; e.currentTarget.style.transform = 'translateY(-2px)'; }} onMouseOut={e => { e.currentTarget.style.background = 'rgba(255, 255, 255, 0.15)'; e.currentTarget.style.transform = 'translateY(0)'; }}>Join my Substack</a>
            </div>
          </div>
        </div>
      )}
